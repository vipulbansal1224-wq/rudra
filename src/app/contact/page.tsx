          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
                <h3 className="text-xl font-bold text-heading mb-6 border-b pb-3">Corporate Office</h3>
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-heading text-sm">Office Address</h4>
                      <p className="text-text text-sm mt-1 leading-relaxed">{contact.address || "34 A, SD Complex, Opposite Housing Board, Distt Panchkula, Haryana, 133302"}</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-heading text-sm">Call/WhatsApp Desk</h4>
                      <p className="text-text text-sm mt-1">{contact.phone1 || "+91 97790 74420"} (Sales)</p>
                      <p className="text-text text-sm mt-0.5">{contact.phone2 || "+91 95881 00159"} (Support)</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-heading text-sm">Email Support</h4>
                      <p className="text-text text-sm mt-1">{contact.email || "info@rudrakashenterprises.com"}</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-heading text-sm">Working Hours</h4>
                      <p className="text-text text-sm mt-1">{contact.workingHours || "Monday - Saturday (09:30 AM - 06:30 PM)"}</p>
                    </div>
                  </div>
                </div>
              </div>
