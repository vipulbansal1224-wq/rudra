      ...
      <div>
        <section className="relative overflow-hidden text-white py-32 px-4 text-center min-h-[70vh] flex items-center justify-center">
          ...
          <div className="relative max-w-4xl mx-auto z-20">
            ...
            <h1 className="font-black tracking-tight mb-6 leading-tight drop-shadow-[0_4px_6px_rgba(0,0,0,0.8)]" style={{ fontSize: 'var(--hero-title-size)' }}>
              {hero.title || "Complete Technology & Infrastructure Solutions"}
            </h1>
            <p className="text-gray-100 mb-10 max-w-2xl mx-auto font-medium drop-shadow-[0_2px_3px_rgba(0,0,0,0.8)]" style={{ fontSize: 'var(--hero-subtitle-size)' }}>
        ...
        <section className="py-20 max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-bold text-heading mb-4" style={{ fontSize: 'var(--heading-size)' }}>Our Key Business Solutions</h2>
        ...
        <section className="py-20 bg-gray-100 px-4">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="font-bold text-heading mb-6" style={{ fontSize: 'var(--heading-size)' }}>{about.title || "Empowering Modern Workspaces Since 2023"}</h2>
              <p className="text-text leading-relaxed mb-6" style={{ fontSize: 'var(--body-size)' }}>{about.description1}</p>
              <p className="text-text leading-relaxed mb-8" style={{ fontSize: 'var(--body-size)' }}>{about.description2}</p>
        ...
        <section className="py-20 bg-white overflow-hidden">
          <div className="text-center mb-12">
            <h2 className="font-bold text-heading mb-4" style={{ fontSize: 'var(--heading-size)' }}>Partners</h2>
            <div className="w-12 h-1 bg-secondary mx-auto mb-4"></div>
        ...
        <section className="py-16 bg-gradient-to-b from-gray-50 to-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="font-bold text-heading mb-4" style={{ fontSize: 'var(--heading-size)' }}>Featured Highlights &amp; Demonstrations</h2>
              <div className="w-12 h-1 bg-secondary mx-auto mb-4"></div>
              <p className="text-text max-w-2xl mx-auto text-base" style={{ fontSize: 'var(--body-size)' }}>Watch our technological solutions, enterprise infrastructure setups, and live project executions in action.</p>
            </div>
              ...
              <div className="bg-white p-4 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 overflow-hidden">
                <div className="relative rounded-xl overflow-hidden bg-black aspect-video flex items-center justify-center shadow-inner">
                  <video controls autoPlay loop muted playsInline poster="/images/vv-1.jpeg" className="w-full h-full object-cover rounded-xl">
                    <source src="/images/vv-2.mp4" type="video/mp4" />
