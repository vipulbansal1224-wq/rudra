    ...
    <header className="w-full bg-white shadow-sm sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8">
          ...
          <Link className="text-sm font-semibold transition-colors duration-200 text-gray-600 hover:text-primary" href="/services">Services</Link>
          <Link className="text-sm font-semibold transition-colors duration-200 text-gray-600 hover:text-primary" href="/about">About Us</Link>
          <Link className="text-sm font-semibold transition-colors duration-200 text-gray-600 hover:text-primary" href="/contact">Contact Us</Link>
        </nav>
        <button className="md:hidden p-2 rounded-md hover:bg-gray-100 text-gray-600 focus:outline-none">
