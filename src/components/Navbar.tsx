  ...
  return (
    <header className="w-full bg-white shadow-sm sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
        <Link className="flex items-center text-decoration-none py-1" href="/">
          <img alt="Rudraksh Enterprises" className="h-12 sm:h-16 md:h-20 w-auto object-contain" src="/logo-2.jpeg"/>
        </Link>
